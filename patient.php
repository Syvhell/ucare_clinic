        ...
        course_id='$_POST[course_id]',
         ...
         WHERE patientid='$_GET[editid]'";
          ...
          echo "<script>
            ...
            console.log('Patient Name: ' + '$_POST[patientname]');
            console.log('Admission Date: ' + '$_POST[admissiondate]');
            console.log('Admission Time: ' + '$_POST[admissiontime]');
            console.log('Address: ' + '$_POST[address]');
            console.log('Mobile Number: ' + '$_POST[mobilenumber]');
            console.log('Login ID: ' + '$_POST[loginid]');
            console.log('Blood Group: ' + '$_POST[select2]');
            console.log('Gender: ' + '$_POST[gender]');
            console.log('Date of Birth: ' + '$_POST[dateofbirth]');
            console.log('Course ID: ' + '$_POST[course_id]');
            console.log('Edit ID: ' + '$_GET[editid]');
        </script>";
...
<?php
        ...
        {
            echo "<script>console.log('Query execution failed: " . mysqli_error($conn) . "');</script>";
    ...
    else
    {
        ...
        $sql ="INSERT INTO patient(patientname,admissiondate,admissiontime,course_id,address,mobileno,loginid,password,bloodgroup,gender,dob) values('$_POST[patientname]','$_POST[admissiondate]','$_POST[admissiontime]','$_POST[course_id]','$_POST[address]','$_POST[mobilenumber]','$_POST[loginid]','$pass','$_POST[select2]','$_POST[gender]','$_POST[dateofbirth]')";
        if($qsql = mysqli_query($conn,$sql))
        {
?>
<div class="popup popup--icon -success js_success-popup popup--visible">
                                ...
                                <div class="card-block">
                                    <form id="main" method="post" action="" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-4">
                                                <input type="text" class="form-control" name="patientname"
                                                    id="patientname" placeholder="Enter name...." required=""
                                            ...
                                            <div class="col-sm-4">
                                                <input type="number" class="form-control" name="mobilenumber"
                                                    id="mobilenumber" placeholder="Enter mobilenumber...." required=""
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-4">
                                                <input type="date" class="form-control" name="admissiondate"
                                                    id="admissiondate" placeholder="Enter admissiondate...." required=""
                                            ...
                                            <div class="col-sm-4">
                                                <input type="time" class="form-control" name="admissiontime"
                                                    id="admissiontime" placeholder="Enter admissiontime...." required=""
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-4">
                                                <input class="form-control" type="password" name="cnfirmpassword"
                                                    id="cnfirmpassword" />
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-4">
                                                <select name="gender" id="gender" class="form-control" required="">
                                                    ...
                                                    { if($rsedit['gender'] == 'Male') { echo 'selected'; } } ?>>Male
                                                    </option>
                                                    <option value="Female" <?php if(isset($_GET['editid']))
                                                    { if($rsedit['gender'] == 'Female') { echo 'selected'; } } ?>>
                                                        Female</option>
                                                </select>
                                            </div>
                                            ...
                                            <div class="col-sm-4">
                                                <input class="form-control" type="date" name="dateofbirth"
                                                    max="<?php echo date("Y-m-d"); ?>" id="dateofbirth"
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-4">
                                                <select name="course_id" id="course_id" class="form-control"
                                                    required="">
                                                    <option value="">-- Select Course One -- </option>
                                                    <?php
                                                    $sqlcourse= "SELECT * FROM course WHERE delete_flg=0";
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <textarea name="address" id="address"
                                                    class="form-control"><?php if(isset($_GET['editid'])) { echo $rsedit['address']; } ?></textarea>
                                            </div>

...
<div class="popup popup--icon -question js_question-popup popup--visible">
    ...
    <div class="popup__content">
        <h3 class="popup__content__title">
            ...
            <p>
                <a href="view-patient.php?id=<?php echo $_GET['delid']; ?>" class="button button--success"
...
<div class="pcoded-content">
  ...
  while($rs = mysqli_fetch_array($qsql))
  {
    ...
    echo "<tr>
        ...
        <td><strong>Blood type</strong> - $rs[bloodgroup]<br>
        <strong>Gender</strong> - &nbsp;$rs[gender]<br>
        <strong>DOB</strong> - &nbsp;$rs[dob]</td>";

        if(isset($_SESSION['adminid']))
        {
          echo "<td><a href='patient.php?editid=$rs[patientid]' class='btn btn-primary'>Edit</a>
          <a href='view-patient.php?delid=$rs[patientid]' class='btn btn-danger'>Delete</a> <hr>
          <a href='patientreport.php?patientid=$rs[patientid]' class='btn btn-success'>View Report</a></td>";
        }
        echo "</tr>";
      }    
?>

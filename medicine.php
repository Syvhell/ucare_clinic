...
if(isset($_POST['btn_submit']))
{
    ...
    {
        $sql ="UPDATE medicine_inventory SET medicine_name='$_POST[medicine_name]',medicine_qty='$_POST[medicine_qty]' WHERE medicine_id='$_GET[editid]'";
...
<?php
    ...
    {
        $sql ="INSERT INTO medicine_inventory(medicine_name,medicine_qty) values('$_POST[medicine_name]','$_POST[medicine_qty]')";
        if($qsql = mysqli_query($conn,$sql))
        {
?>
<div class="popup popup--icon -success js_success-popup popup--visible">
...
if(isset($_GET['editid']))
{
    $sql="SELECT * FROM medicine_inventory WHERE medicine_id='$_GET[editid]' ";
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="text" class="form-control" name="medicine_name"
                                                    id="medicine_name"
                                                    value="<?php if(isset($_GET['editid'])) { echo $rsedit['medicine_name']; } ?>">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="text" class="form-control" name="medicine_qty"
                                                    id="medicine_qty"
                                                    value="<?php if(isset($_GET['editid'])) { echo $rsedit['medicine_qty']; } ?>" />
                                                <span class="messages"></span>
                                            </div>
                                        </div>

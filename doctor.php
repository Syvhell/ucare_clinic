...
if(isset($_POST['btn_submit']))
{
    ...
    {
        $sql ="UPDATE doctor SET doctorname='$_POST[doctorname]',mobileno='$_POST[mobilenumber]',departmentid='$_POST[department]',loginid='$_POST[loginid]',education='$_POST[education]',experience='$_POST[experience]' WHERE doctorid='$_GET[editid]'";
...
<div class="popup popup--icon -success js_success-popup popup--visible">
    ...
    <div class="popup__content">
        ...
        <p>Health Personel Record Updated Successfully</p>
        <p>
...
<?php
    ...
    else
    {
        ...
        $sql ="INSERT INTO doctor(doctorname,mobileno,departmentid,loginid,password,education,experience) values('$_POST[doctorname]','$_POST[mobilenumber]','$_POST[department]','$_POST[loginid]','$pass','$_POST[education]','$_POST[experience]')";
        if($qsql = mysqli_query($conn,$sql))
        {
?>
<div class="popup popup--icon -success js_success-popup popup--visible">
    ...
    <div class="popup__content">
        ...
        <p>Health Personel Inserted Successfully</p>
        <p>
                        ...
                        <div class="col-lg-4">
                            <div class="page-header-breadcrumb">
                                <ul class="breadcrumb-title">
                                    ...
                                    <li class="breadcrumb-item"><a>Health Personel</a>
                                    </li>
                                    <li class="breadcrumb-item"><a href="add_user.php">Health Personel</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                                ...
                                <div class="card-block">
                                    <form id="main" method="post" action="" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group row">
                                            <label class="col-sm-2 col-form-label">Health Personel Name</label>
                                            <div class="col-sm-4">
                                                <input type="text" class="form-control" name="doctorname"
                                                    id="doctorname" placeholder="Enter name...." required=""
                                                    value="<?php if(isset($_GET['editid'])) { echo $rsedit['doctorname']; } ?>">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-4">
                                                <input class="form-control" type="text" name="experience"
                                                    id="experience"
                                                    value="<?php if(isset($_GET['editid'])) { echo $rsedit['experience']; } ?>" />
                                            </div>

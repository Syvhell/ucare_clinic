...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 19, 2024 at 03:03 PM
...
(1, 'admin', '00-00000', 'aa7f019c326413d5b8bcad4314228bcd33ef557f5d81c7cc977f7728156f4357', 'Jacob Pogi', 'admin', 'Male', '2018-11-26', '9758518361', '<p>Maharashtra, India</p>\r\n', '<p>admin panel</p>\r\n', 'profile.jpg', '2018-04-30', '2019-10-15', 1, '0000-00-00', 0);
...
INSERT INTO `course` (`course_id`, `course_name`, `delete_flg`) VALUES
(8, 'BS in Information Technology ', 0),
(9, 'BS in Office Administration ', 0),
(10, 'Bachelor of Elementary Education', 0),
(11, 'Bachelor of Secondary Education', 0),
(12, 'BS in Criminology', 0),
(13, 'BS in Agriculture', 0),
(14, 'BS Forestry', 0),
(15, 'BS in Hospitality Management ', 0),
(16, 'BS Tourism Management ', 0),
(17, 'BS in Nutrition and Dietetics', 0);
...
(7, 'Clinic Department', 'For General Check Up', NULL, 0),
(8, 'Dental Department', 'For Mouth Check Up', NULL, 0);
...
CREATE TABLE `doctor` (
  ...
  `consultancy_charge` float(10,2) DEFAULT NULL,
  `delete_status` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci;
...
(8, 'Dr. Elana Ramos', '09654657654', 8, '00-00001', '4bda0284a9632e80fd94500ec09f3164b867ab6a5d78f6a0b038b04f21753708', '', 'Doctorate', 8.0, NULL, 0),
(9, 'Rn. Billy Wielsh', '09887656765', 7, '00-00002', '4bda0284a9632e80fd94500ec09f3164b867ab6a5d78f6a0b038b04f21753708', '', 'Masters', 4.0, NULL, 0),
(10, 'Dr. Kaloy Hermones', '09776854376', 7, '00-00003', '4bda0284a9632e80fd94500ec09f3164b867ab6a5d78f6a0b038b04f21753708', '', 'Doctorate', 6.0, NULL, 0);
...
INSERT INTO `medicine_inventory` (`medicine_id`, `medicine_name`, `medicine_qty`, `delete_flg`) VALUES
(5, 'Paracetamol (Acetaminophen)', 50, 0),
(6, 'Ibuprofen', 50, 0),
(7, 'Aspirin', 50, 0),
(8, 'Diclofenac', 50, 0),
(9, 'Amoxicillin', 50, 0),
(10, 'Azithromycin', 50, 0),
(11, 'Ciprofloxacin', 50, 0),
(12, 'Cephalexin', 50, 0);
...
INSERT INTO `patient` (`patientid`, `patientname`, `admissiondate`, `admissiontime`, `address`, `mobileno`, `course_id`, `city`, `pincode`, `loginid`, `password`, `bloodgroup`, `gender`, `dob`, `status`, `delete_status`) VALUES
(20, 'John Keban Antonio Perez', '2024-10-21', '20:51:00', '', '09667439437', 12, NULL, NULL, '18-10574', '4bda0284a9632e80fd94500ec09f3164b867ab6a5d78f6a0b038b04f21753708', 'A+', 'Male', '1999-02-20', NULL, 0);
...
INSERT INTO `services` (`service_id`, `department_id`, `service_name`, `delete_flg`) VALUES
(17, 8, 'Mouth Examination', 0),
(18, 8, 'Tooth Extraction', 0),
(19, 8, 'Tooth Restoration', 0),
(20, 8, 'Prophylaxis', 0),
(21, 7, 'Blood Pressure (Vital Signs Taking)', 0),
(22, 7, 'Body Temperature (Vital Signs Taking)', 0),
(23, 7, 'Pulse Rate (Respiratory Rate)', 0),
(24, 7, 'Ht & Wt (Respiratory Rate)', 0),
(25, 8, 'Random Glucose Blood Testing (Diagnostic Testing)', 0),
(26, 7, 'Fasting Glucose Blood Testing  (Diagnostic Testing)', 0),
(27, 7, 'Pregnancy Testing  (Diagnostic Testing)', 0),
(28, 7, 'Ostoscopy  (Diagnostic Testing)', 0),
(29, 7, 'Consultation and Treatment', 0),
(30, 7, 'Prescription of Medicine', 0);
...
CREATE TABLE `treatment_records` (
  ...
  `medicine_dispense` varchar(255) DEFAULT NULL,

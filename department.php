...
if(isset($_POST['btn_submit']))
{
    ...
    {
            $sql ="UPDATE department SET departmentname='$_POST[departmentname]',description='$_POST[description]' WHERE departmentid='$_GET[editid]'";
...
<?php
    ...
    {
    $sql ="INSERT INTO department(departmentname,description) values('$_POST[departmentname]','$_POST[description]')";
    if($qsql = mysqli_query($conn,$sql))
    {
?>
<div class="popup popup--icon -success js_success-popup popup--visible">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="text" class="form-control" name="departmentname"
                                                    id="departmentname" placeholder="Enter name...." required=""
                                                    value="<?php if(isset($_GET['editid'])) { echo $rsedit['departmentname']; } ?>">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-8">
                                                <textarea name="description" id="description"
                                                    class="form-control"><?php if(isset($_GET['editid'])) { echo $rsedit['description']; } ?></textarea>
                                                <span class="messages"></span>
                                            </div>
                                        </div>
